                        ...
                        <div className="space-y-6">
                            <div className="flex justify-between items-start">
                                ...
                                <div className="text-right">
                                    ...
                                    <span className="text-2xl font-black text-pink-500">€14.99</span>
                                </div>
                            </div>
                            ...
                            <div className="bg-blue-900/20 border border-blue-500/20 p-3 rounded flex items-start space-x-3">
                                ...
                                <p className="text-[10px] text-gray-300 leading-relaxed">
                                    By purchasing the Beta, you secure a <strong>Lifetime License</strong>. The price will increase to €29.99 upon full release v3.0.
                                </p>
                            </div>
