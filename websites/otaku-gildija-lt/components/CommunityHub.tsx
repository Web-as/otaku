...
import { User, Trophy, BarChart, Activity, MessageSquare, Zap, Star, Share2, Copy, Check, X, Camera, Send, Coins, Target, Wand2, Loader, Eye, FolderOpen, PlayCircle } from 'lucide-react';
import { UserProfile, WatchListItem, ActivityItem, BlogPost, Quest, GachaItem } from '../types';
import { MOCK_USERS, MOCK_BLOG_POSTS as INITIAL_BLOG_POSTS, getBlogPosts, addBlogPost, MOCK_QUESTS, MOCK_GACHA_ITEMS } from '../services/mockData';
...
const CommunityHub: React.FC<CommunityHubProps> = ({ userId }) => {
    const [activeTab, setActiveTab] = useState<'Overview' | 'History' | 'Inventory'>('Overview');
        ...
        <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-4">
                ...
                <div className="space-y-6">
                    ...
                    <section>
                         <h3 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-4">Daily Missions</h3>
