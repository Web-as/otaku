...
import { quickQuery, sendChatMessage } from '../../services/aiAgent';
    ...
    const handleSendMessage = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            if (!useDeepThink && inputValue.startsWith("/fast ")) {
                 responseText = await quickQuery(inputValue.replace("/fast ", ""));
            } else {
                 responseText = await sendChatMessage(userMsg.text, useDeepThink);
            }
