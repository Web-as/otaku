...
const PostEditor = ({ post, onSave, onClose }: PostEditorProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-[#1a1a1f] border border-gray-800 rounded-lg w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-900 border border-gray-800 text-white px-4 py-3 rounded-lg focus:border-violet-500 outline-none transition"
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full bg-gray-900 border border-gray-800 text-white px-4 py-3 rounded-lg focus:border-violet-500 outline-none transition resize-none"
          ...
          <div>
            ...
            <textarea
              ...
              rows={12}
              className="w-full bg-gray-900 border border-gray-800 text-white px-4 py-3 rounded-lg focus:border-violet-500 outline-none transition resize-none font-mono text-sm"
