...
import { Video, Image as ImageIcon, Eye, Upload, Sparkles, Loader, PlayCircle, Film, Camera } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto min-h-screen p-4 md:p-8 animate-in fade-in slide-in-from-bottom-4">
            <header className="mb-8">
                <h1 className="text-3xl md:text-4xl font-black text-white uppercase italic tracking-tighter">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-pink-500">Creative</span> Studio
                </h1>
                <p className="text-gray-500 text-sm font-mono mt-1 uppercase tracking-widest">AI Powered Production Suite</p>
            </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-3 space-y-2">
                    ...
                    >
                        ...
                        <div>
                            <div className="font-bold uppercase text-sm">Nano Banana Pro</div>
                    ...
                    >
                        ...
                        <div>
                            <div className="font-bold uppercase text-sm">Veo Motion</div>
                    ...
                    >
                        ...
                        <div>
                            <div className="font-bold uppercase text-sm">Scanner</div>
...
// Quick helper icon import fix if needed
