...
import { Globe, ArrowRight, Shield, Zap, Users, Play, Star, ChevronDown, Monitor } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen bg-[#0f0e17] text-white overflow-x-hidden font-sans selection:bg-pink-500 selection:text-white">
      ...
      <div className="hidden">
        <h1>Library of Otaku - Anime Manager & Community</h1>
        <h2>Otaku Gildija - Lietuvos Anime Bendruomenė</h2>
        <p>Track your anime watch history, earn badges, and organize your files with the ultimate otaku dashboard.</p>
      </div>

      {/* --- PARALLAX BACKGROUND LAYERS --- */}
      
      {/* Layer 1: Deep Grid (Moves slowly) */}
      <div 
      ...
      {/* Layer 2: Glowing Orbs (Moves medium speed) */}
      <div 
      ...
      {/* Layer 3: Floating Particles (CSS Animation) */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen py-12 px-4">
        ...
        >
            ...
            <h1 className="text-4xl md:text-7xl font-black tracking-tight mb-4 leading-none">
                CHOOSE YOUR <br className="block md:hidden"/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-gray-400">REALITY</span>
            </h1>
            <p className="text-gray-400 max-w-xs md:max-w-lg mx-auto font-mono text-xs md:text-sm tracking-widest uppercase">
                The Ultimate Gamified Anime Library Platform
            </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 w-full max-w-4xl perspective-1000">
            ...
            >
                ...
                <div className="relative z-10 flex flex-col h-full">
                    <div className="flex justify-between items-start mb-4 md:mb-6">
                        ...
                        {hoveredRegion === 'LT' && (
                             <span className="bg-green-500/20 text-green-400 text-[9px] md:text-[10px] font-bold px-2 py-1 rounded uppercase animate-pulse border border-green-500/30">
                                 Recommended
                             </span>
                        )}
                    </div>
                    
                    <h2 className="text-2xl md:text-3xl font-black mb-2 group-hover:text-violet-400 transition-colors">Otaku Gildija</h2>
                    <p className="text-gray-400 text-xs md:text-sm mb-6 md:mb-8 font-mono">
                        Prisijunk prie Lietuvos anime bendruomenės. Rūšiuok failus, kelk lygį ir tapk legenda.
                    </p>
                    ...
                    <div className="mt-auto">
                        ...
                        <button className="w-full py-3 md:py-4 bg-white/5 hover:bg-violet-600 border border-white/10 hover:border-violet-500 rounded-lg font-bold text-xs md:text-sm uppercase tracking-widest transition-all flex items-center justify-center group-hover:shadow-lg">
                            Prisijungti <ArrowRight className="w-4 h-4 md:w-5 md:h-5 ml-2 group-hover:translate-x-1 transition-transform" />
                        </button>
                    </div>
                </div>
            </div>
            ...
            >
                ...
                <div className="relative z-10 flex flex-col h-full">
                    ...
                    <h2 className="text-2xl md:text-3xl font-black mb-2 group-hover:text-pink-400 transition-colors">Library of Otaku</h2>
                    <p className="text-gray-400 text-xs md:text-sm mb-6 md:mb-8 font-mono">
                        The advanced anime library manager for serious collectors. Track stats, organize files, and share profiles.
                    </p>
                    ...
                    <div className="mt-auto">
                        ...
                        <button className="w-full py-3 md:py-4 bg-white/5 hover:bg-pink-600 border border-white/10 hover:border-pink-500 rounded-lg font-bold text-xs md:text-sm uppercase tracking-widest transition-all flex items-center justify-center group-hover:shadow-lg">
                            Enter Portal <ArrowRight className="w-4 h-4 md:w-5 md:h-5 ml-2 group-hover:translate-x-1 transition-transform" />
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div className="absolute bottom-6 text-center w-full text-[9px] md:text-[10px] text-gray-600 font-mono uppercase tracking-widest pointer-events-none">
            <p>Otaku Nexus Network • v2.4.0-BETA</p>
        </div>
      </div>
    </div>
  );
